...
> 
> ~~~
> Error in ddply(chorizon, .(cokey), .fun = component_level_aggregation, : could not find function "ddply"
> ~~~
> {: .error}
> 
> 
...
> 
> ~~~
> Error in eval(expr, envir, enclos): object 'soil_content' not found
> ~~~
> {: .error}
> 
{: .textchunk}
