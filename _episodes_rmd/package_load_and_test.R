...
# test FedData
SSURGO.areas <- get_ssurgo(template=c('CO670'), label='CO_TEST')
SSURGO.areas.CO670 <- SSURGO.areas$spatial[SSURGO.areas$spatial$AREASYMBOL=='CO670',]
NED.CO670 <- get_ned(template=SSURGO.areas.CO670, label='SSURGO_CO670')
plot(NED.CO670)
