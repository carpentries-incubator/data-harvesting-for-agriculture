...
- How can I work with a spreadsheet in a more advanced and reproducible manner than
  using MS Excel?
...
```{r stuff4, echo=FALSE, fig.width=8, fig.height=6}
x = c(22:31)
y = c(243:252)
plot(x~y)
```

```{r stuff3, echo=FALSE, fig.width=8, fig.height=6}
x = c(322:331)
y = c(243:252)
plot(x~y)
```
