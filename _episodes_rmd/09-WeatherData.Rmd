...
The Oak Ridge National Laboratory produces a dataset called Daymet (Thornton et al 2021) that contains historical estimates of daily weather variables interpolated from available weather stations to a one kilometer grid. Daymet provides daily precipitation, min and max temperature, snow water equivalent, temperature, day length, solar radiation, and vapor pressure, and are updated monthly.
