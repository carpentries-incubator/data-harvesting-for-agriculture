...
subplots_merge <- SpatialPolygonsDataFrame(grid_sp, merge, match.ID = FALSE)
subplots_data <- st_as_sf(subplots_merge) 
...
ov <- st_over(asapplied_utm, st_geometry(buffer))
asapplied$out <- is.na(ov) # demarcate the yield values removed
