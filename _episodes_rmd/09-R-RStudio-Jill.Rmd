...
<font color="magenta">I think we should do this after head and discussing different types of data. (DENA: Can we ditch this entirely? Do we need str if we've given them the head example already?)</font>
