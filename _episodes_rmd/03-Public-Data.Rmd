...
weather data. This should be a point near the middle of the field. 
...
We also call the site `Field1`, but this will be the name of a specific field if you use it in the future. We can 
...
equivalent are not so apparent. Use the `datmetr` [vignette](https://cran.r-project.org/web/packages/daymetr/vignettes/daymetr-vignette.html) to understand the meaning of these variables.
