...
<!-- TODO <font color="magenta">This could use a bit of re-writing - I just put the SSURGO stuff in with the weather data</font> -->
...
<!-- TODO <font color="magenta">JPN: Do we need this subsetting here?  Do we ever use `&` again?  We haven't introduced boolean operations at all until right now so we should be sure we actually need it</font> -->
