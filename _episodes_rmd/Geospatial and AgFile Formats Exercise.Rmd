...
to look up the function and check the class and contents of `projutm`.  How does
this compare to the output of `crs(trial)`?
...
a title in `tm_polygons ` and why is `legend.outside = TRUE`?
