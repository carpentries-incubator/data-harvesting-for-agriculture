...
> #### Transforming
> 
> The function `st_transform_utm()` transforms a simple feature that is in lat/long into UTM. This function is in the functions.R script, and is described there in more detail. Make sure that you are running `source("functions.R")` or you will not have the function in your global environment.
> ```{r transform}
